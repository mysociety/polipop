...
DATABASES = {
    'default': {
        ...
        'NAME':     config.get('POLIPOP_DB_NAME'),
        'USER':     config.get('POLIPOP_DB_USER'),
        'PASSWORD': config.get('POLIPOP_DB_PASS'),
        'HOST':     config.get('POLIPOP_DB_HOST'),
        'PORT':     config.get('POLIPOP_DB_PORT'),
    }
}
...
ROOT_URLCONF = 'polipop.urls'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join( base_dir, "polipop/templates" ),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "polipop.popit.context_processors.add_settings",
)
