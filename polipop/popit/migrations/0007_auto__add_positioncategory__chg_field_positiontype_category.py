...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('popit_positiontype', 'category')
        db.add_column('popit_positiontype', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['popit.PositionCategory'], null=True))


    def backwards(self, orm):
        
        # Removing index on 'PositionType', fields ['category']
        db.delete_index('popit_positiontype', ['category_id'])

        # Deleting model 'PositionCategory'
        db.delete_table('popit_positioncategory')

        db.delete_column('popit_positiontype', 'category_id')
        db.add_column('popit_positiontype', 'category', self.gf('django.db.models.fields.CharField')(max_length=20))
